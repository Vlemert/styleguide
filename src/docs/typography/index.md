...
- [Font size modifiers](#font-size-modifiers)
...
| `$base-font-family-sans-serif` | `"FF Milo", "Lucida Grande", sans-serif` | The base font-family for *sans-serif* fonts. |
...
| `$base-line-height` | `1.3` | The base line-height for all text based on the font-size of the element. |
...
| `$h1-font-size` | `ms(6)` | The default font-size for `H1`. |
| `$h2-font-size` | `ms(5)` | The default font-size for `H2`. |
| `$h3-font-size` | `ms(4)` | The default font-size for `H3`. |
| `$h4-font-size` | `ms(3)` | The default font-size for `H4`. |
| `$h5-font-size` | `ms(2)` | The default font-size for `H5`. |
| `$h6-font-size` | `ms(-1)` | The default font-size for `H6`. |
